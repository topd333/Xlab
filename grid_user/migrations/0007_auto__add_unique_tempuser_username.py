...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TempUser', fields ['username']
        db.create_unique(u'grid_user_tempuser', ['username'])


    def backwards(self, orm):
        # Removing unique constraint on 'TempUser', fields ['username']
        db.delete_unique(u'grid_user_tempuser', ['username'])
