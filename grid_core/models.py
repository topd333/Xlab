...
class Avatars(models.Model):
    avatarid = models.AutoField(
        primary_key=True, db_column='AvatarID')  # Newly added
...
class Friends(models.Model):
    friendid = models.AutoField(
        primary_key=True, db_column='FriendID')  # Newly added
...
class Griduser(models.Model):
    userid = models.CharField(
        max_length=255L, primary_key=True, db_column='UserID')
...
class Presence(models.Model):
    presenceid = models.AutoField(
        primary_key=True, db_column='PresenceID')  # Newly added
    ...
    sessionid = models.CharField(
        max_length=36L, unique=True, db_column='SessionID')
    securesessionid = models.CharField(
        max_length=36L, db_column='SecureSessionID')
...
class Useraccounts(models.Model):
    useraccountid = models.AutoField(
        primary_key=True, db_column='UserAccountID')  # Newly added
    principalid = models.CharField(
        max_length=36L, unique=True, db_column='PrincipalID')
...
class HgTravelingData(models.Model):
    sessionid = models.CharField(
        max_length=36L, primary_key=True, db_column='SessionID')
    userid = models.CharField(max_length=36L, db_column='UserID')
    gridexternalname = models.CharField(
        max_length=255L, db_column='GridExternalName')
    servicetoken = models.CharField(max_length=255L, db_column='ServiceToken')
    clientipaddress = models.CharField(
        max_length=16L, db_column='ClientIPAddress')
...
class Inventoryfolders(models.Model):
    foldername = models.CharField(
        max_length=64L, db_column='folderName', blank=True)
    type = models.IntegerField()
    version = models.IntegerField()
    folderid = models.CharField(
        max_length=36L, primary_key=True, db_column='folderID')
    agentid = models.CharField(max_length=36L, db_column='agentID', blank=True)
    parentfolderid = models.CharField(
        max_length=36L, db_column='parentFolderID', blank=True)
...
class Inventoryitems(models.Model):
    ...
    assettype = models.IntegerField(
        null=True, db_column='assetType', blank=True)
    inventoryname = models.CharField(
        max_length=64L, db_column='inventoryName', blank=True)
    inventorydescription = models.CharField(
        max_length=128L, db_column='inventoryDescription', blank=True)
    inventorynextpermissions = models.IntegerField(
        null=True, db_column='inventoryNextPermissions', blank=True)
    inventorycurrentpermissions = models.IntegerField(
        null=True, db_column='inventoryCurrentPermissions', blank=True)
    ...
    inventorybasepermissions = models.IntegerField(
        db_column='inventoryBasePermissions')
    inventoryeveryonepermissions = models.IntegerField(
        db_column='inventoryEveryOnePermissions')
    ...
    inventoryid = models.CharField(
        max_length=36L, primary_key=True, db_column='inventoryID')
    avatarid = models.CharField(
        max_length=36L, db_column='avatarID', blank=True)
    parentfolderid = models.CharField(
        max_length=36L, db_column='parentFolderID', blank=True)
    inventorygrouppermissions = models.IntegerField(
        db_column='inventoryGroupPermissions')
...
class OsGroupsGroups(models.Model):
    groupid = models.CharField(
        max_length=36L, primary_key=True, db_column='GroupID')
    ...
    openenrollment = models.CharField(
        max_length=255L, db_column='OpenEnrollment')
...
class OsGroupsInvites(models.Model):
    inviteid = models.CharField(
        max_length=36L, primary_key=True, db_column='InviteID')
    groupid = models.CharField(max_length=36L, db_column='GroupID')
...
class OsGroupsMembership(models.Model):
    groupmembershipid = models.AutoField(
        primary_key=True, db_column='GroupMembershipID')  # Newly added
    groupid = models.CharField(max_length=36L, db_column='GroupID')
    principalid = models.CharField(max_length=255L, db_column='PrincipalID')
    selectedroleid = models.CharField(
        max_length=36L, db_column='SelectedRoleID')
...
class OsGroupsNotices(models.Model):
    groupid = models.CharField(max_length=36L, db_column='GroupID')
    noticeid = models.CharField(
        max_length=36L, primary_key=True, db_column='NoticeID')
    ...
    attachmentname = models.CharField(
        max_length=128L, db_column='AttachmentName')
    attachmentitemid = models.CharField(
        max_length=36L, db_column='AttachmentItemID')
    attachmentownerid = models.CharField(
        max_length=255L, db_column='AttachmentOwnerID')
...
class OsGroupsPrincipals(models.Model):
    principalid = models.CharField(
        max_length=255L, primary_key=True, db_column='PrincipalID')
...
class OsGroupsRolemembership(models.Model):
    grouprolemembershipid = models.AutoField(
        primary_key=True, db_column='GroupRoleMembershipID')  # Newly added
    groupid = models.CharField(max_length=36L, db_column='GroupID')
    roleid = models.CharField(max_length=36L, db_column='RoleID')
    principalid = models.CharField(max_length=255L, db_column='PrincipalID')
...
class OsGroupsRoles(models.Model):
    grouproleid = models.AutoField(
        primary_key=True, db_column='GroupRoleID')  # Newly added
    groupid = models.CharField(max_length=36L, db_column='GroupID')
    roleid = models.CharField(max_length=36L, db_column='RoleID')
    name = models.CharField(max_length=255L, db_column='Name')
...
class Regions(models.Model):
    ...
    regionname = models.CharField(
        max_length=128L, db_column='regionName', blank=True)
    regionrecvkey = models.CharField(
        max_length=128L, db_column='regionRecvKey', blank=True)
    regionsendkey = models.CharField(
        max_length=128L, db_column='regionSendKey', blank=True)
    regionsecret = models.CharField(
        max_length=128L, db_column='regionSecret', blank=True)
    regiondatauri = models.CharField(
        max_length=255L, db_column='regionDataURI', blank=True)
    serverip = models.CharField(
        max_length=64L, db_column='serverIP', blank=True)
    serverport = models.IntegerField(
        null=True, db_column='serverPort', blank=True)
    serveruri = models.CharField(
        max_length=255L, db_column='serverURI', blank=True)
    ...
    eastoverridehandle = models.BigIntegerField(
        null=True, db_column='eastOverrideHandle', blank=True)
    westoverridehandle = models.BigIntegerField(
        null=True, db_column='westOverrideHandle', blank=True)
    southoverridehandle = models.BigIntegerField(
        null=True, db_column='southOverrideHandle', blank=True)
    northoverridehandle = models.BigIntegerField(
        null=True, db_column='northOverrideHandle', blank=True)
    regionasseturi = models.CharField(
        max_length=255L, db_column='regionAssetURI', blank=True)
    regionassetrecvkey = models.CharField(
        max_length=128L, db_column='regionAssetRecvKey', blank=True)
    regionassetsendkey = models.CharField(
        max_length=128L, db_column='regionAssetSendKey', blank=True)
    regionuseruri = models.CharField(
        max_length=255L, db_column='regionUserURI', blank=True)
    regionuserrecvkey = models.CharField(
        max_length=128L, db_column='regionUserRecvKey', blank=True)
    regionusersendkey = models.CharField(
        max_length=128L, db_column='regionUserSendKey', blank=True)
    regionmaptexture = models.CharField(
        max_length=36L, db_column='regionMapTexture', blank=True)
    serverhttpport = models.IntegerField(
        null=True, db_column='serverHttpPort', blank=True)
    serverremotingport = models.IntegerField(
        null=True, db_column='serverRemotingPort', blank=True)
    owner_uuid = models.CharField(max_length=36L)
    originuuid = models.CharField(
        max_length=36L, db_column='originUUID', blank=True)
    ...
    parcelmaptexture = models.CharField(
        max_length=36L, db_column='parcelMapTexture', blank=True)
...
class Tokens(models.Model):
    tokenid = models.AutoField(
        primary_key=True, db_column='TokenID')  # Newly added
