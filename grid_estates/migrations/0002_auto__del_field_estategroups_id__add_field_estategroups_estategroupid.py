...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EstateGroups.id'
        #db.delete_column(u'estate_groups', u'id')

        # Adding field 'EstateGroups.estategroupid'
        db.add_column(u'estate_groups', 'estategroupid',
                      self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True, db_column=u'EstateGroupID'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EstateGroups.id'
        db.add_column(u'estate_groups', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True),
                      keep_default=False)

        # Deleting field 'EstateGroups.estategroupid'
        db.delete_column(u'estate_groups', u'EstateGroupID')
